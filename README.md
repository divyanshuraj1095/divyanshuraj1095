...
```javascript
const divyanshu = {
  education : "B.Tech IT @ CUSAT (CGPA: 8.64)",
  currently  : "Building full-stack apps & grinding DSA",
  interests  : ["Web Dev", "System Design", "Open Source", "Competitive Programming"],
  funFact    : "My code works — I'm just not sure why 😅",
};
```
...
- 🥇 **Special Jury Award** — Ranked **#20 out of 1100+ teams** at hackathons
- 🛠️ **Open Source** — Merged PR [#10853](https://github.com/axios/axios/pull/10853) in **Axios** (fixing interceptor docs)
- 💼 **Infosys Springboard 6.0** — Built fraud detection UI for BFSI platform
- 🧩 **300+ DSA problems** solved on LeetCode & Codeforces
- 🏅 Hackathons: **Hack Europa**, **CodeRecet 2.0**, **Hack-Nocturne**
